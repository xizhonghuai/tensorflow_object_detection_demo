...
if __name__ == '__main__':
    ...
    # 生成训练文件
    # imgPath = "dataset"
    # csv_input = 'data/xizhonghuai_train.csv'
    # output_path = 'data/xizhonghuai_train.record'
    # main(csv_input, output_path, imgPath)
    #
    # 生成验证文件
    imgPath = "dataset/test_dataset"
    csv_input = 'data/xizhonghuai_test.csv'
    output_path = 'data/xizhonghuai_test.record'
    main(csv_input, output_path, imgPath)
